...
begin:'""'}],starts:a
},e.COMMENT("^\\s*%\\{\\s*$","^\\s*%\\}\\s*$"),e.COMMENT("%","$")]}}})());hljs.registerLanguage("java",(()=>{"use strict"
...
skip:!0})]}]})})());hljs.registerLanguage("leaf",(()=>{"use strict";return e=>({name:"Leaf",
...
end:'"'},{className:"variable",begin:"[A-Za-z_][A-Za-z_0-9]*"}]}]}]})})());hljs.registerLanguage("powershell",(()=>{"use strict";return e=>{const n={
$pattern:/-?[A-z\.\-]+\b/,
...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("plaintext",(()=>{"use strict";return t=>({
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
name:"TypeScript",aliases:["ts","tsx"]}),m}})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
...
className:"number",begin:"(&[oO][0-7]{1,6})"}]})})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,keyword:".PHONY"}},r]}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
});return{name:"LaTeX",aliases:["tex","latex"],
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("vbscript",(()=>{"use strict";function e(e){
...
relevance:0}),e.C_NUMBER_MODE]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return"("+((e=>{
const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
;var n})).join("|")+")"}return n=>{
